...
function launch(v){
 ...
 if(flight===cards.length-1){$('status').textContent='最後一張牌留下了，靜候答案。';setTimeout(()=>{if(flight===cards.length-1)revealFinalCard();},900);}
}
